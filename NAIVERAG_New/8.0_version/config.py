...
SCORE_THRESHOLD = 0.6  # 放宽距离阈值（原0.3，增大以召回更多相关片段）
...
QUERY_REWRITING_MODEL = "local-qwen-0.6b"
    ...
    "local-qwen-1.5b": {
        ...
        "params": {
            "model_path": os.getenv("",
                                    r"D:\projects\fastapi_langchain_env\NAIVERAG_New\model\Qwen2.5-1.5B-Instruct"),
            "temperature": 0.3,
            "max_new_tokens": 512,
            "top_p": 0.9,
            "device": DEVICE,
